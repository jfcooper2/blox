...
PROTOCOL_BUFFERS_PYTHON_IMPLEMENTATION=python python simulator.py --sim-type synthetic --jobs-per-hour 1 --start-job-track 0 --end-job-track 400 --exp-prefix test --placement SGavel --scheduler Las
